"""Voici la version 4.5, la version Finale ! Ce programme reprend le célèbre jeu Motus"""
...
console = Console()
console.clear()
nbLettresUsr = int(input("Combien de lettres chaque mot à deviner (entre 3 et 21 lettres) -> "))
while nbLettresUsr < 3 or nbLettresUsr > 21:
    console.print("En dehors du critère ! Recommence")
    nbLettresUsr = int(input("Combien de lettres chaque mot à deviner (entre 3 et 21 lettres) -> "))
